...
%%----------------------------------------
\title{Computer‐Vision‐based surveillance of Intelligent Transportation Systems}
\author{João Neto}
...
\supervisor{Supervisor}{Rosaldo Rossetti, PhD}

%% Uncomment next line if necessary
\supervisor{Second Supervisor}{Diogo Santos, MsC}
